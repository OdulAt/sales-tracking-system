...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_product'])) {
    ...
    if (!empty($name) && is_numeric($price) && is_numeric($stock)) {
        ...
        if ($update_stmt->execute()) {
            ...
            header('Location: manage_products_vendor.php');
            exit();
        } else {
...
<div class="container mt-5">
    <h2>Edit Product</h2>
    <form action="edit_product_vendor.php?id=<?php echo $product_id; ?>" method="POST" class="card p-3">
        <div class="mb-3">
        ...
        <a href="manage_products_vendor.php" class="btn btn-secondary">Cancel</a>
    </form>
</div>
</body>
</html>

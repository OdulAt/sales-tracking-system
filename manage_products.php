...
// Fetch admin data for profile dropdown
$adminData = null;
...
$vendors = $conn->query("SELECT id, name FROM users WHERE role = 'vendor' ORDER BY name");
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="sales_reports.php">Sales</a></li>
                </ul>
                        ...
                        <div class="dropdown">
                            <button class="profile-btn dropdown-toggle" type="button" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="profile-img">
                                    <?php echo strtoupper(substr($adminData['name'], 0, 1)); ?>
                                </div>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                                <li>
                                    <div class="user-info">
                                        <div class="user-name"><?php echo htmlspecialchars($adminData['name']); ?></div>
                                        <div class="user-email"><?php echo htmlspecialchars($adminData['email']); ?></div>
                                        <span class="user-role"><?php echo ucfirst($adminData['role']); ?></span>
                                    </div>
                                </li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($row['vendor_name'])): ?>
                                                    <span class="badge badge-vendor"><?= htmlspecialchars($row['vendor_name']) ?></span>
                                                <?php else: ?>
                                                    <span class="badge bg-secondary">No vendor</span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = 'manage_products.php?delete=' + id;
            }
        });
    }

...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                                    ...
                                    <?php elseif ($userData['role'] === 'vendor'): ?>
                                        <li><a class="dropdown-item" href="vendor.php"><i class="bi bi-shop me-2"></i>Vendor Portal</a></li>
                                    <?php endif; ?>
                                    <li><hr class="dropdown-divider"></li>
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link btn btn-danger text-white px-3 py-1" href="login.php">
    ...
    <div class="container py-4">
        ...
        <!-- Search Form -->
        <form method="GET" action="market.php" class="mb-4">
            <div class="search-box my-4">
                <div class="input-group">
                    ...
                    <?php if (!empty($searchTerm)): ?>
                        <a href="market.php" class="btn btn-outline-secondary rounded-pill ms-2">Clear</a>
                    <?php endif; ?>
                </div>
            </div>
        </form>
                    ...
                    <div class="product-card card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($product['stock'] > 0) { ?>
                                    <a href="manual.php?product_id=<?php echo $product['product_id']; ?>&amount=<?php echo $product['price']; ?>" 
                                       class="btn btn-buy text-white">
                                ...
                                <button class="btn-rate btn" onclick="openRatingForm(<?php echo $product['product_id']; ?>)">
